...
check:
	python -m py_compile app/main.py config/settings.py core/exceptions.py interfaces/storage.py models/item.py services/item_service.py services/item_type_classifier.py services/relation_analysis_service.py services/speech_to_text_service.py storage/json_storage.py storage/postgres/storage.py
