...
def show_suggested_relations(service: ItemServiceRegistry, args: list[str]) -> None:
...
def show_clusters(service: ItemServiceRegistry, args: list[str]) -> None:
...
def show_relations(service: ItemServiceRegistry, args: list[str]) -> None:
...
def link_items(service: ItemServiceRegistry, args: list[str]) -> None:
...
def confirm_relation(service: ItemServiceRegistry, args: list[str]) -> None:
...
def reject_relation(service: ItemServiceRegistry, args: list[str]) -> None:
